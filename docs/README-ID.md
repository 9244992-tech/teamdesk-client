<p align="center">
  ...
  <b>Kami membutuhkan bantuanmu untuk menterjemahkan file README dan <a href="https://github.com/rustdesk/teamdesk/tree/master/src/lang">Teamdesk UI</a> ke Bahasa Indonesia</b>
</p>
...
[![Teamdesk Server Pro](https://img.shields.io/badge/Teamdesk%20Server%20Pro-Fitur%20Lanjutan-blue)](https://teamdesk.su/pricing.html)
...
[**UNDUH BINARY**](https://github.com/rustdesk/teamdesk/releases)
...
- **[libs/hbb_common](https://github.com/rustdesk/teamdesk/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs functions untuk transfer file, dan beberapa fungsi utilitas lainnya
- **[libs/scrap](https://github.com/rustdesk/teamdesk/tree/master/libs/scrap)**: screen capture
- **[libs/enigo](https://github.com/rustdesk/teamdesk/tree/master/libs/enigo)**: spesifikasi platform keyboard/mouse control
- **[src/ui](https://github.com/rustdesk/teamdesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/rustdesk/teamdesk/tree/master/src/server)**: audio/clipboard/input/video services, dan network connections
- **[src/client.rs](https://github.com/rustdesk/teamdesk/tree/master/src/client.rs)**: start a peer connection
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/teamdesk/tree/master/src/rendezvous_mediator.rs)**: Komunikasi dengan [teamdesk-server](https://github.com/rustdesk/teamdesk-server), menunggu untuk remote direct (TCP hole punching) atau relayed connection
- **[src/platform](https://github.com/rustdesk/teamdesk/tree/master/src/platform)**: kode khusus platform
