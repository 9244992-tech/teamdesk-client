...
- Dacă patch-ul tău nu este revizuit sau ai nevoie ca o anumită persoană să-l revizuiască, poți @-reply unui reviewer cerând o revizuire în pull request sau într-un comentariu, sau poți solicita o revizuire prin [email](mailto:info@teamdesk.su).
...
[Codul de Conduită Teamdesk](https://github.com/rustdesk/teamdesk/blob/master/docs/CODE_OF_CONDUCT.md)
