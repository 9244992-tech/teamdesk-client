<p align="center">
  ...
  <b>Ni bezonas helpon traduki tiun README kaj <a href="https://github.com/rustdesk/teamdesk/tree/master/src/lang">la interfacon</a> al via denaska lingvo</b>
</p>
...
[**BINARA ELŜUTO**](https://github.com/rustdesk/teamdesk/releases)
...
- **[libs/hbb_common](https://github.com/rustdesk/teamdesk/tree/master/libs/hbb_common)**: videa kodeko, agordado, kovrilo tcp/udp, protobuf, funkcioj fs por dosiertransigo, kaj aliaj utilaĵaj funkcioj
- **[libs/scrap](https://github.com/rustdesk/teamdesk/tree/master/libs/scrap)**: ekrankaptado
- **[libs/enigo](https://github.com/rustdesk/teamdesk/tree/master/libs/enigo)**: operaciumspecifa kontrolo de klavaro/muso
- **[src/ui](https://github.com/rustdesk/teamdesk/tree/master/src/ui)**: interfaco
- **[src/server](https://github.com/rustdesk/teamdesk/tree/master/src/server)**: aŭdio/poŝo/enigo/videa servoj, kaj retkonektoj
- **[src/client.rs](https://github.com/rustdesk/teamdesk/tree/master/src/client.rs)**: starti konekto kun samtavolo
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/teamdesk/tree/master/src/rendezvous_mediator.rs)**: komuniki kun [teamdesk-server](https://github.com/rustdesk/teamdesk-server), atendi foran direktan (TCP hole punching) aŭ relajsatan konekton
- **[src/platform](https://github.com/rustdesk/teamdesk/tree/master/src/platform)**: operaciumspecifa kodo
