<p align="center">
  ...
  <b>Χρειαζόμαστε τη βοήθειά σας για να μεταφράσουμε αυτό το αρχείο README, το <a href="https://github.com/rustdesk/teamdesk/tree/master/src/lang">Teamdesk UI</a> και το <a href="https://github.com/rustdesk/doc.teamdesk.su">Doc</a> στη μητρική σας γλώσσα</b>
</p>
...
[![Teamdesk Server Pro](https://img.shields.io/badge/Teamdesk%20Server%20Pro-%CE%A0%CF%81%CE%BF%CE%B7%CE%B3%CE%BC%CE%AD%CE%BD%CE%B5%CF%82%20%CE%94%CF%85%CE%BD%CE%B1%CF%84%CF%8C%CF%84%CE%B7%CF%84%CE%B5%CF%82-blue)](https://teamdesk.su/pricing.html)

Ένα λογισμικό απομακρυσμένης επιφάνειας εργασίας, γραμμένο σε γλώσσα Rust. Δεν χρειάζεται κάποια παραμετροποίηση, λειτουργεί αμέσως μετά την εγκατάσταση. Έχετε τον πλήρη έλεγχο των δεδομένων σας, χωρίς να ανησυχείτε για την ασφάλειά τους. Μπορείτε να χρησιμοποιήσετε τους προκαθορισμένους διακομιστές rendezvous/αναμετάδοσης, [να εγκαταστήσετε τον δικό σας διακομιστή](https://teamdesk.su/server), ή [να αναπτύξετε ένα δικό σας διακομιστή rendezvous/αναμετάδοσης](https://github.com/rustdesk/teamdesk-server-demo).
...
[**Συχνές ερωτήσεις**](https://github.com/rustdesk/teamdesk/wiki/FAQ)

[**Κατεβάστε τα αρχεία**](https://github.com/rustdesk/teamdesk/releases)
...
- **[flutter](https://github.com/rustdesk/teamdesk/tree/master/flutter)**: Flutter code for mobile
- **[flutter/web/js](https://github.com/rustdesk/teamdesk/tree/master/flutter/web/js)**: JavaScript for Flutter web client
