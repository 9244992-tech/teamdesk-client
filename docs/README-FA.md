...
<p dir="rtl" align="center"><b>برای ترجمه این سند (README)، <a href="https://github.com/rustdesk/teamdesk/tree/master/src/lang" dir="rtl">رابط کاربری Teamdesk</a>، <a href="https://github.com/rustdesk/doc.teamdesk.su" dir="rtl">و مستندات آن</a> به زبان مادری شما به کمکتان نیازمندیم. </b></p>
...
[![Teamdesk Server Pro](https://img.shields.io/badge/Teamdesk%20Server%20Pro-%D9%88%DB%8C%DA%98%DA%AF%DB%8C%E2%80%8C%D9%87%D8%A7%DB%8C%20%D9%BE%DB%8C%D8%B4%D8%B1%D9%81%D8%AA%D9%87-blue)](https://teamdesk.su/pricing.html)
...
می‌توانید از سرور rendezvous/relay ما استفاده کنید، [سرور خودتان را راه‌اندازی کنید](https://teamdesk.su/server) یا
[ سرورrendezvous/relay  خود را بنویسید](https://github.com/rustdesk/teamdesk).

ما از مشارکت همه استقبال می کنیم. برای راهنمایی جهت مشارکت به[`docs/CONTRIBUTING.md`](CONTRIBUTING.md) مراجعه کنید.

[راست‌دسک چطور کار می کند؟](https://github.com/rustdesk/teamdesk/wiki/How-does-Teamdesk-work%3F)

[دریافت نرم‌افزار](https://github.com/rustdesk/teamdesk/releases)
...
## [ساخت](https://teamdesk.su/docs/en/dev/build/)
