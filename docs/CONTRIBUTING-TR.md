...
- Yamalarınız gözden geçirilmiyorsa veya belirli bir kişinin gözden geçirmesine ihtiyacınız varsa, çekme isteği veya yorum içinde bir gözden geçirmeyi istemek için bir inceleyiciyi @etiketleyebilir veya inceleme için [e-posta](mailto:info@teamdesk.su) ile talep edebilirsiniz.
...
https://github.com/rustdesk/teamdesk/blob/master/docs/CODE_OF_CONDUCT-TR.md
