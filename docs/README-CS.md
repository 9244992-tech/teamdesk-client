<p align="center">
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/rustdesk/teamdesk/tree/master/src/lang">uživatelského rozhraní aplikace Teamdesk</a> a <a href="https://github.com/rustdesk/doc.teamdesk.su">dokumentace k ní</a> do vašeho jazyka</b>
</p>
...
[![Teamdesk Server Pro](https://img.shields.io/badge/Teamdesk%20Server%20Pro-Pokro%C4%8Dil%C3%A9%20Funkce-blue)](https://teamdesk.su/pricing.html)

Zase další software pro přístup k ploše na dálku, naprogramovaný v jazyce Rust. Funguje hned tak, jak je – není třeba žádného nastavování. Svá data máte ve svých rukách, bez obav o zabezpečení. Je možné používat námi poskytovaný propojovací/předávací (relay) server, [vytvořit si svůj vlastní](https://teamdesk.su/server), nebo [si dokonce svůj vlastní naprogramovat](https://github.com/rustdesk/teamdesk-server-demo), budete-li chtít.

Projekt Teamdesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak Teamdesk funguje?**](https://github.com/rustdesk/teamdesk/wiki/How-does-Teamdesk-work%3F)

[**STAHOVÁNÍ ZKOMPILOVANÝCH APLIKACÍ**](https://github.com/rustdesk/teamdesk/releases)
...
## [Sestavení ze zdrojových kódů](https://teamdesk.su/docs/en/dev/build/)
...
- **[libs/hbb_common](https://github.com/rustdesk/teamdesk/tree/master/libs/hbb_common)**: kodek videa, nastavení, obalovaní tcp/udp, vyrovnávací paměť protokolu, funkce souborového systému pro přenos souborů a pár dalších podpůrných funkcí
- **[libs/scrap](https://github.com/rustdesk/teamdesk/tree/master/libs/scrap)**: zachytávání obsahu obrazovky
- **[libs/enigo](https://github.com/rustdesk/teamdesk/tree/master/libs/enigo)**: ovládání klávesnice/myši pro jednotlivé platformy
- **[src/ui](https://github.com/rustdesk/teamdesk/tree/master/src/ui)**: grafické uživatelské rozhraní
- **[src/server](https://github.com/rustdesk/teamdesk/tree/master/src/server)**: služby pro zvuk/schránku/zadávání/video a síťová spojení
- **[src/client.rs](https://github.com/rustdesk/teamdesk/tree/master/src/client.rs)**: spouští připojení k protějšku
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/teamdesk/tree/master/src/rendezvous_mediator.rs)**: komunikace s [teamdesk-server](https://github.com/rustdesk/teamdesk-server), očekávání vzdálených příméhých („proděrováváním“ TCP) nebo předávaných (relay) spojení
- **[src/platform](https://github.com/rustdesk/teamdesk/tree/master/src/platform)**: zdrojové kódy, specifické pro jednotlivé platformy
- **[flutter](https://github.com/rustdesk/teamdesk/tree/master/flutter)**: zdrojové kódy pro použití s aplikačním rámcem (framework) Flutter pro mobilní platformy
- **[flutter/web/js](https://github.com/rustdesk/teamdesk/tree/master/flutter/web/js)**: Javascript pro Flutter webový klient
