...
// https://github.com/rustdesk/teamdesk/issues/8599
...
fn _map_keyboard_mode(_peer: &str, event: &Event, mut key_event: KeyEvent) -> Option<KeyEvent> {
    ...
    let keycode = match _peer {
        OS_LOWER_WINDOWS => {
            // https://github.com/rustdesk/teamdesk/issues/1371
...
// https://github.com/rustdesk/teamdesk/wiki/FAQ#keyboard-translation-modes
