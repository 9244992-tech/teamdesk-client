...
pub fn get_cur_device_string() -> &'static str {
    match IDD_IMPL {
        IDD_IMPL_TEAMDESK => TEAMDESK_IDD_DEVICE_STRING,
...
pub fn plug_in_headless() -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_TEAMDESK => teamdesk_idd::plug_in_headless(),
...
pub fn plug_in_monitor(idx: u32, modes: Vec<virtual_display::MonitorMode>) -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_TEAMDESK => teamdesk_idd::plug_in_index_modes(idx, modes),
...
pub fn plug_in_peer_request(modes: Vec<Vec<virtual_display::MonitorMode>>) -> ResultType<Vec<u32>> {
    match IDD_IMPL {
        IDD_IMPL_TEAMDESK => teamdesk_idd::plug_in_peer_request(modes),
        IDD_IMPL_AMYUNI => {
...
pub fn plug_out_monitor_indices(
    ...
    match IDD_IMPL {
        IDD_IMPL_TEAMDESK => teamdesk_idd::plug_out_peer_request(indices),
        IDD_IMPL_AMYUNI => {
...
pub fn reset_all() -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_TEAMDESK => teamdesk_idd::reset_all(),
...
pub mod teamdesk_idd {
    ...
    fn get_device_names() -> Vec<String> {
        windows::get_device_names(Some(super::TEAMDESK_IDD_DEVICE_STRING))
    }
