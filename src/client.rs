...
pub const SCRAP_X11_REF_URL: &str = "https://teamdesk.su/docs/en/manual/linux/#x11-required";
...
lazy_static::lazy_static! {
    static ref LOGIN_ERROR_MAP: Arc<HashMap<&'static str, LoginErrorMsgBox>> = {
        ...
        let map = HashMap::from([(LOGIN_SCREEN_WAYLAND, LoginErrorMsgBox{
            ...
            link: "https://teamdesk.su/docs/en/manual/linux/#login-screen",
            try_again: true,
...
pub trait Interface: Send + Clone + 'static + Sized {
    ...
    fn on_establish_connection_error(&self, err: String) {
        ...
        // deadline: https://github.com/rustdesk/teamdesk-server-pro/discussions/325, most likely comes from secure tcp timeout
        {
            relay_hint = true;
            if !received {
