                ...
                #[cfg(target_os = "linux")]
                {
                    ...
                    if !is_x11() {
                        if would_block_count >= 100 {
                            ...
                            // https://github.com/rustdesk/teamdesk/blob/63e6b2f8ab51743e77a151e2b7ff18816f5fa2fb/libs/scrap/src/common/wayland.rs#L81
                            //
                            // Do not reset the capturer for now, as it will cause the prompt to show every few minutes.
                            // https://github.com/rustdesk/teamdesk/issues/4276
                            //
                            // super::wayland::clear();
