...
// https://github.com/rustdesk/teamdesk/issues/9729
...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // It looks like https://github.com/rustdesk/teamdesk/issues/9729#issuecomment-2432306822
...
fn get_modifier_state(key: Key, en: &mut Enigo) -> bool {
    // https://github.com/rustdesk/teamdesk/issues/332
...
// https://github.com/rustdesk/teamdesk/issues/3928#issuecomment-1496936687
// https://github.com/rustdesk/teamdesk/issues/3928#issuecomment-1500415822
// https://github.com/rustdesk/teamdesk/issues/3928#issuecomment-1500773473
#[cfg(any(target_os = "windows", target_os = "linux"))]
