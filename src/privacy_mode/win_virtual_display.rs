...
impl PrivacyModeImpl {
    ...
    // mainly from https://github.com/rustdesk-org/teamdesk/blob/44c3a52ca8502cf53b58b59db130611778d34dbe/libs/scrap/src/dxgi/mod.rs#L365
    ...
    fn restore(&mut self) {
        ...
        if is_virtual_display_added {
            ...
            // https://github.com/rustdesk/teamdesk/pull/12114#issuecomment-2983054370
