...
//
// See https://github.com/rustdesk/teamdesk/discussions/11959
//
// `ausearch -x /usr/share/teamdesk/teamdesk` will return
// ...
...
// type=SYSCALL msg=audit(1750776043.446:192757): arch=c000003e syscall=59 success=no exit=-2 a0=7fb7dbd22da0 a1=1d65f2c0 a2=7ffc25193360 a3=7ffc25194ec0 items=1 ppid=172208 pid=267565 auid=4294967295 uid=0 gid=0 euid=0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=(none) ses=4294967295 comm="teamdesk" exe="/usr/share/teamdesk/teamdesk" subj=unconfined key="processos_criados"
// ----
// time->Tue Jun 24 10:40:43 2025
...
pub fn get_display_server() -> String {
    ...
    if let Ok(forced_display) = std::env::var("TEAMDESK_FORCED_DISPLAY_SERVER") {
...
fn _get_values_of_seat0(indices: &[usize], ignore_gdm_wayland: bool) -> Vec<String> {
    if let Ok(output) = run_loginctl(None) {
        ...
        // some case, there is no seat0 https://github.com/rustdesk/teamdesk/issues/73
        for line in String::from_utf8_lossy(&output.stdout).lines() {
            if ignore_loginctl_line(line) {
                continue;
            }
