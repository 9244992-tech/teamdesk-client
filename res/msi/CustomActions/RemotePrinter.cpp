...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\TeamdeskPrinterDriver\\TeamdeskPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"Teamdesk Printer";
    LPCWCH RD_PRINTER_NAME = L"Teamdesk Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"Teamdesk v4 Printer Driver";
