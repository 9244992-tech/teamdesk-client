...
#
# - versionName from https://github.com/rustdesk/teamdesk/releases/download/fdroid-version/teamdesk-version.txt
# - versionCode from https://github.com/rustdesk/teamdesk/releases/download/fdroid-version/teamdesk-version.txt
...
arm64-v8a)
	...
	TEAMDESK_FEATURES='flutter,hwcodec'
	;;
armeabi-v7a)
...
prebuild)
	...
	# Flutter used to compile main Teamdesk library
	...
	# version used to compile Teamdesk library, generate bridge using the
