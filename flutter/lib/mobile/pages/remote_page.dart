...
class _RemotePageState extends State<RemotePage> with WidgetsBindingObserver {
  ...
  void onSoftKeyboardChanged(bool visible) {
    if (!visible) {
      ...
      // https://github.com/rustdesk/teamdesk/discussions/11843#discussioncomment-13499698 - Virtual keyboard issue
      if (isIOS) {
        _iosKeyboardWorkaroundTimer?.cancel();
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          // workaround for https://github.com/rustdesk/teamdesk/issues/3131
