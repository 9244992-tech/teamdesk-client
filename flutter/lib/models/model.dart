...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/rustdesk/teamdesk/discussions/14048
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/rustdesk/teamdesk/pull/3706#issuecomment-1481242389
  ...
  void edgeScrollMouse(double x, double y) async {
    ...
    if (encroachment.length2 == 0) {
      ...
      var bumpMouseSucceeded = _bumpMouseIsWorking &&
          (await teamDeskWinManager.call(WindowType.Main, kWindowBumpMouse,
